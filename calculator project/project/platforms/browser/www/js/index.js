...
var result3; //this variable stores the numbers that are entered after the decimal is pressed
var result4; //this variable stores the integer part of result1
...
var plus_or_minus_clicked = false;//a boolean indicating whether the +/- sign has been clicked after a symbol is clicked
var dot_clicked = false;//a boolean indicating whether the '.' sign has been clicked
...
$(".number").click(function(){
    ...
    if (number_clicked == true && symbol_clicked == false){
        if (dot_clicked == true){
            result3 = result.join('');
            result3 = parseInt(result3, 10);
            result3 = result3/Math.pow(10, result.length);
            if (result.length == 1){
            result4 = result1;
    }
...
$(".symbol").click(function(){
    ...
    if(operation.length>2 || symbol_clicked == true){
        operation.shift();
    }
    percentage_clicked = false;
    plus_or_minus_clicked = false;
    dot_clicked = false;
...
$(".difference1").click(function(){
    if(number_clicked == true){
        result1 = -result1;
        console.log(result1);
        $(".a0").text(result1);
    } else if (symbol_clicked == true){
        plus_or_minus_clicked = true;
    }
})
...
function check_plus_or_minus(){
    if (plus_or_minus_clicked==true){
        result1=-result1;
    }
}
